...
const init = () => {
  ...
  camera = new THREE.PerspectiveCamera(
    ...
    0.1,   // Near plane plus éloigné
    1000 // Far plane plus éloigné
  )
  camera.position.z = 5
  ...
  controls.minDistance = 3             // Distance minimale de zoom réduite
  controls.maxDistance = 10            // Distance maximale de zoom augmentée
